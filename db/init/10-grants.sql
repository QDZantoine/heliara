...
GRANT EXECUTE ON PROCEDURE heliara.pub_list_testimonials TO 'app_read'@'%';
...
-- Les témoignages. La section « Ils en parlent mieux que nous » de l'accueil.
GRANT EXECUTE ON PROCEDURE heliara.list_testimonials     TO 'app_write'@'%';
GRANT EXECUTE ON PROCEDURE heliara.create_testimonial    TO 'app_write'@'%';
GRANT EXECUTE ON PROCEDURE heliara.update_testimonial    TO 'app_write'@'%';
GRANT EXECUTE ON PROCEDURE heliara.publish_testimonial   TO 'app_write'@'%';
GRANT EXECUTE ON PROCEDURE heliara.reorder_testimonials  TO 'app_write'@'%';
GRANT EXECUTE ON PROCEDURE heliara.delete_testimonial    TO 'app_write'@'%';
GRANT EXECUTE ON PROCEDURE heliara.pub_list_testimonials TO 'app_write'@'%';
